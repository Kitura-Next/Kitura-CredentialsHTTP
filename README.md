...
<p align="center">
    ...
    <a href="https://travis-ci.org/Kitura-Next/Kitura-CredentialsHTTP">
    <img src="https://travis-ci.org/Kitura-Next/Kitura-CredentialsHTTP.svg?branch=master" alt="Build Status - Master">
    </a>
...
## Summary
A plugin for [Kitura-Credentials](https://github.com/Kitura-Next/Kitura-Credentials) framework that authenticates using HTTP Basic and Digest authentication.
...
Add the `Kitura-CredentialsHTTP` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `Kitura-CredentialsHTTP` [release](https://github.com/Kitura-Next/Kitura-CredentialsHTTP/releases).

```swift
.package(url: "https://github.com/Kitura-Next/Kitura-CredentialsHTTP.git", from: "x.x.x")
```
